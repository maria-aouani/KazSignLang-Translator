...
train_labels_dir = '/media/robotics-300/8bf075d6-3600-4c70-8f2d-0d11f1ca9e25/robotics300/PycharmProjects/MediaPipe_Yolo_Lstm_222/MP_Data/train/labels'
load_labels(train_labels_dir)

# Function to plot image with bounding boxes and keypoints for both hands
def plot_image_with_keypoints(image_path, bbox1, keypoints1, bbox2, keypoints2):
    ...
    # Draw bounding boxes for both hands
    ...
    # Draw keypoints and connections for both hands
...
def parse_label_file(label_path):
    ...
    if len(lines) > 1:  # Check if there's a second hand
        hand2 = list(map(float, lines[1].split()))
        bbox2 = hand2[1:5]
        keypoints2 = hand2[5:]
    else:
        # If there's no second hand, default the values to None or zeros
        bbox2, keypoints2 = None, None

    return bbox1, keypoints1, bbox2, keypoints2

# Updated plot function to handle one or two hands
def plot_image_with_keypoints(image_path, bbox1, keypoints1, bbox2=None, keypoints2=None):
    ...
    # Function to draw a single hand (bbox and keypoints)
    ...
    # If there is a second hand, draw it as well
...
# Example usage
label_path = '/media/robotics-300/8bf075d6-3600-4c70-8f2d-0d11f1ca9e25/robotics300/PycharmProjects/MediaPipe_Yolo_Lstm_222/MP_Data/train/labels/forget00.txt'
image_path = '/media/robotics-300/8bf075d6-3600-4c70-8f2d-0d11f1ca9e25/robotics300/PycharmProjects/MediaPipe_Yolo_Lstm_222/MP_Data/train/images/forget00.jpg'
bbox1, keypoints1, bbox2, keypoints2 = parse_label_file(label_path)
plot_image_with_keypoints(image_path, bbox1, keypoints1, bbox2, keypoints2)
...
class TrainingConfig:
    ...
    NAME: str = field(default_factory=lambda: f"{os.path.splitext('yolov8n-pose.pt')[0]}_50_epochs")
...
model.train(data=train_config.DATASET_YAML, epochs=train_config.EPOCHS, imgsz=data_config.IMAGE_SIZE,
            batch=data_config.BATCH_SIZE, device=device)
